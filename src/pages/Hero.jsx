...
export default function Hero() {
  ...
  return (
    <>
      <section
        id="home"
        className="min-h-screen flex flex-col items-center justify-center px-4 py-20 text-center relative overflow-hidden bg-gradient-to-b from-white via-rose-50/30 to-white"
      >
        ...
        >
          ...
          >
            <span className="px-4 py-1 text-sm bg-rose-50 text-rose-600 rounded-full border border-rose-200">
              Nhớ lấy ngày vui của tụi mình nha!
            </span>
          </motion.div>
          ...
          <div className="space-y-8">
            ...
            >
              Tụi mình sắp về chung một nhà rồi!
            </motion.p>
            <motion.h2
            ...
            <div className="relative px-8 py-10 rounded-2xl border border-rose-100/50">
              ...
              <div className="space-y-6 text-center">
                ...
                <motion.div
                  ...
                  className="space-y-2"
                >
                  <p className="text-gray-500 font-serif italic">Thương gửi.</p>
                  <p className="text-gray-600 font-medium">
                    Ba/Mẹ/Anh/Chị iu dấu
                  </p>
                  <p className="text-rose-500 font-semibold text-lg">
                    {guestName ? guestName : "Bạn iu"}
                  </p>
                </motion.div>
              </div>
